...
import AboutImg from '../public/assets/ahmed.png';
      ...
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          I specialize in building mobile responsive front-end UI applications
            ...
            React, Vue, Angular, Nuxtjs and Nextjs I am a quick learner and can pick up new tech stacks as
        ...
        <div className='w-full h-auto m-auto flex items-center justify-center p-4 hover:scale-105 ease-in duration-300'>
          <Image src={AboutImg} className='rounded-xl !-top-[176px]' alt='/' />
        </div>
      </div>
    </div>
  );
